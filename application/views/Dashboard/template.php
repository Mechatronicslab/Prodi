...
<div class="wrapper">
	...
	<header class="main-header">
		...
		<a href="index2.html" class="logo">
			...
			<span class="logo-mini"><b>UA</b>P</span>
			<!-- logo for regular state and mobile devices -->
			<span class="logo-lg"><b>UBL APPS</b> Prodi</span>
		</a>
					...
					<li class="dropdown user user-menu">
						...
						<ul class="dropdown-menu">
							...
							<li class="user-header">
								...
								<p>
									<?php echo $user['name']?>
									<small><?php echo $user['nmlengkap']?></small>
								</p>
							</li>
							<!-- Menu Footer-->
	...
	<footer class="main-footer">
		<strong>Copyright &copy; <a href="http://ublapps.ubl.ac.id">Ubl Apps 2017</a> MIS.</strong> All rights
		reserved.
	</footer>
